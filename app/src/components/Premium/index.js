    ...
    return (
      ...
      <div className={css(styles.home, styles.parameters)}>
        <Paper zDepth={1} className={css(styles.parampaper)}>
          <h2 className={css(styles.papertitle)}>Your quote</h2>
          <div className={css(styles.huge)}>
            Ξ {this.props.parameters.premium}
          </div>
          <Divider />
          <Table>
      ...
      <div className={css(styles.premiumCoverButtonDiv)}>
        <RaisedButton label="ACCEPT" secondary={true} fullWidth={true} onTouchTap={this.handleThisTap} />
      </div>
      </div>
    );
  }
